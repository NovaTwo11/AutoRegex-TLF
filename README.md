...
Este proyecto fue desarrollado como parte de la asignatura de **Teoría de Lenguajes Formales**, con el objetivo de detectar y validar patrones en textos e interfaces interactivas. 

Para demostrar el dominio técnico, **el motor de validación se construyó completamente desde cero utilizando el fundamento matemático de los Autómatas Finitos**, cumpliendo con la restricción estricta de no utilizar librerías predefinidas de expresiones regulares en Python.
...
* **Interfaz Interactiva (Tkinter):** Formularios que reaccionan en tiempo real, bloqueando el envío de inconsistencias a la base de datos.
